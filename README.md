...
>
> [!WARNING]
> **【重要】利用規約とアカウント停止のリスクについて / Terms of Service & Account Risk**
> 
> 本ツールは Google Antigravity の非公式な自動化ツールです。Antigravity の利用規約では、サードパーティ製ツールや自動化スクリプトによるサービスへのアクセスが制限されている場合があります。
> 
> **規約違反と判断された場合、該当の Google アカウントが予告なく一時停止、または永久的に削除（BAN）されるリスクがあります。**
> 
> これにより、登録されているすべての Google サービス（Gmail, ドライブ, YouTube 等）へのアクセスが失われる可能性があります。業務用や大切な個人用アカウントでの利用は避け、万が一アカウントが停止されても支障のない検証用環境での利用を強く推奨します。
